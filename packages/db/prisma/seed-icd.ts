...
const commonIcdCodes = [
    ...
    { code: 'E11.21', description: 'Type 2 diabetes mellitus with diabetic nephropathy', category: 'Endocrine, nutritional and metabolic diseases' },
    { code: 'E11.40', description: 'Type 2 diabetes mellitus with diabetic neuropathy, unspecified', category: 'Endocrine, nutritional and metabolic diseases' },
    { code: 'E03.9', description: 'Hypothyroidism, unspecified', category: 'Endocrine, nutritional and metabolic diseases' },
    { code: 'E78.5', description: 'Hyperlipidemia, unspecified', category: 'Endocrine, nutritional and metabolic diseases' },

    // Respiratory
    { code: 'J00', description: 'Acute nasopharyngitis [common cold]', category: 'Diseases of the respiratory system' },
    { code: 'J01.90', description: 'Acute sinusitis, unspecified', category: 'Diseases of the respiratory system' },
    ...
    { code: 'J20.9', description: 'Acute bronchitis, unspecified', category: 'Diseases of the respiratory system' },
    ...
    { code: 'K29.70', description: 'Gastritis, unspecified, without bleeding', category: 'Diseases of the digestive system' },
    { code: 'K58.0', description: 'Irritable bowel syndrome with diarrhea', category: 'Diseases of the digestive system' },
    { code: 'K59.00', description: 'Constipation, unspecified', category: 'Diseases of the digestive system' },

    // Musculoskeletal
    { code: 'M54.5', description: 'Low back pain', category: 'Diseases of the musculoskeletal system and connective tissue' },
    { code: 'M25.50', description: 'Pain in unspecified joint', category: 'Diseases of the musculoskeletal system and connective tissue' },
    { code: 'M17.9', description: 'Osteoarthritis of knee, unspecified', category: 'Diseases of the musculoskeletal system and connective tissue' },

    // Symptoms
    { code: 'R50.9', description: 'Fever, unspecified', category: 'Symptoms, signs and abnormal clinical and laboratory findings' },
    { code: 'R05', description: 'Cough', category: 'Symptoms, signs and abnormal clinical and laboratory findings' },
    { code: 'R51', description: 'Headache', category: 'Symptoms, signs and abnormal clinical and laboratory findings' },
    { code: 'R10.9', description: 'Unspecified abdominal pain', category: 'Symptoms, signs and abnormal clinical and laboratory findings' },
    { code: 'R53.83', description: 'Other fatigue', category: 'Symptoms, signs and abnormal clinical and laboratory findings' },
    ...
    { code: 'A41.9', description: 'Sepsis, unspecified organism', category: 'Certain infectious and parasitic diseases' },
];
