...
/**
 * ShareInvoiceButton Component
 * 
 * Allows sharing invoice PDFs via WhatsApp with a pre-filled message.
...
export function ShareInvoiceButton({
  ...
  return (
    <Button
      ...
      aria-label={`Share invoice with ${patientName} via WhatsApp`}
    >
      {loading ? (
        <>
