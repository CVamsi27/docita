...
export interface PrescriptionTemplateManagerProps {
  onTemplateSelect?: (template: PrescriptionTemplate) => void;
}

export const PrescriptionTemplateManager = memo(
  function PrescriptionTemplateManager({
    onTemplateSelect,
    ...
    const loadTemplates = useCallback(async () => {
      try {
        setLoading(true);
        const data = await apiFetch<PrescriptionTemplate[]>(
    ...
    const handleSaveTemplate = useCallback(async () => {
      ...
      try {
        ...
        const url = editingTemplate
          ? `/prescription-templates/${editingTemplate.id}`
          : `/prescription-templates`;
    ...
    }, [editingTemplate, formData, loadTemplates, resetForm]);
