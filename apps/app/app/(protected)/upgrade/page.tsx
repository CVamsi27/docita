...
export default function UpgradePage() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>
                Current Plan: {getTierInfo(currentTier).name}
              </CardTitle>
              <CardDescription>
        ...
        <Card className="border-amber-200 bg-amber-50/50 dark:bg-amber-950/20">
          ...
          <CardContent>
            <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
              {lockedFeatures
                .slice(0, 6)
                .map(({ feature, details, requiredTier }) => {
            ...
            {lockedFeatures.length > 6 && (
              <p className="mt-4 text-sm text-muted-foreground text-center">
                +{lockedFeatures.length - 6} more features available in higher
                tiers
              </p>
            )}
          </CardContent>
        ...
        <Card className="border-primary/50 bg-primary/5">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => setShowContactSalesModal(true)}>
                Contact Sales
              </Button>
            </div>
          </CardHeader>
      ...
      {/* Intelligence Add-on */}
      {!hasIntelligence && (
        <Card className="border-pink-200 bg-linear-to-br from-pink-50 to-purple-50 dark:from-pink-950/20 dark:to-purple-950/20">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="flex items-center gap-2">
