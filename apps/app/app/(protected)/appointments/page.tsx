  ...
  return (
    ...
    >
      ...
      <ConfirmationDialog
        ...
        description="Are you sure you want to cancel this appointment? The patient will not be notified automatically."
      ...
      <ConfirmationDialog
        ...
        isDestructive={true}
        isLoading={updateAppointmentMutation.isPending}
        onConfirm={handleNoShowAppointment}
      />
    </FeatureGate>
  );
}
