  ...
  const rows: FeatureComparisonRow[] = [
    // Limits
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => [
          t,
          PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].patients === 999999
            ? "Unlimited"
            : PLAN_LIMITS[
                Tier[t] as keyof typeof PLAN_LIMITS
    ...
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => [
          t,
          PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].doctors === 999
            ? "Unlimited"
            : PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].doctors,
        ]),
    ...
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => [
          t,
          `${PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].storageGB} GB`,
        ]),
      ) as Record<Tier, string>,
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => [
          t,
          PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].branches === 999
            ? "Unlimited"
            : PLAN_LIMITS[Tier[t] as keyof typeof PLAN_LIMITS].branches,
        ]),
      ) as Record<Tier, string | number>,
    },
    // Core Features
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => [
          t,
          t >= FEATURE_TIER_MAP[Feature.DIGITAL_PRESCRIPTIONS],
        ]),
    ...
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => {
          ...
          if (t >= FEATURE_TIER_MAP[Feature.ONE_WAY_WHATSAPP])
            return [t, "Basic"];
          return [t, false];
        }),
    ...
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => {
          if (t >= FEATURE_TIER_MAP[Feature.OCR_ADVANCED])
            return [t, "Advanced"];
    ...
    },
    {
      ...
      values: Object.fromEntries(
        tiers.map((t) => {
          if (t >= FEATURE_TIER_MAP[Feature.ADVANCED_ANALYTICS])
            return [t, "Advanced"];
          if (t >= FEATURE_TIER_MAP[Feature.BASIC_ANALYTICS])
            return [t, "Basic"];
          return [t, false];
        }),
      ) as Record<Tier, string | boolean>,
...
export function getPlanHighlights(
  ...
  features.push({
    name:
      limits.patients === 999999
        ? "Unlimited patients"
        : `Up to ${limits.patients.toLocaleString()} patients`,
    included: true,
  });
