...
interface PermissionState {
    ...
    getTierInfo: (tier?: Tier) => { name: string; description: string; tagline: string; color: string }
}
...
export const usePermissionStore = create<PermissionState>((set, get) => ({
    ...
    setTier: (tier) => {
        ...
        if (typeof tier === 'string') {
            switch (tier) {
                case 'CAPTURE': parsedTier = Tier.CAPTURE; break;
                case 'CORE': parsedTier = Tier.CORE; break;
                case 'PLUS': parsedTier = Tier.PLUS; break;
                case 'PRO': parsedTier = Tier.PRO; break;
                case 'ENTERPRISE': parsedTier = Tier.ENTERPRISE; break;
                // Legacy mappings
                case 'FREE': parsedTier = Tier.CAPTURE; break;
                case 'STARTER': parsedTier = Tier.CORE; break;
                case 'PROFESSIONAL': parsedTier = Tier.PRO; break;
                default: parsedTier = Tier.CAPTURE;
            }
        } else {
            parsedTier = tier
        }
