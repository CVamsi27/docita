...
export function Sidebar() {
  ...
  return (
    <div 
      className={cn(
        "relative flex h-full flex-col border-r border-sidebar-border bg-sidebar transition-all duration-300 ease-in-out z-10",
    ...
    >
      ...
      <div className={cn(
        ...
        <div className="flex items-center overflow-hidden whitespace-nowrap">
          ...
          <Button variant="ghost" size="icon" onClick={() => setIsCollapsed(!isCollapsed)} className="ml-auto hidden lg:flex">
