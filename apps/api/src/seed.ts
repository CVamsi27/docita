...
async function main() {
    ...
    try {
        ...
        // Create users (doctors and receptionists)
        ...
        const prescription1 = await prisma.prescription.create({
            data: {
                ...
                patientId: patients[0].id,
                doctorId: doctor1.id,
                instructions: 'Take medications as prescribed. Follow low-sugar diet. Exercise 30 mins daily.',
                medications: {
                    create: [
                        {
                            name: 'Metformin',
        ...
        console.log('\n📊 Summary:');
        console.log(`   - Users: 3 (2 doctors, 1 receptionist)`);
        ...
        console.log('\n🔑 Login credentials:');
        console.log('   - doctor@docita.com / password123');
        console.log('   - dr.sharma@docita.com / password123');
        console.log('   - reception@docita.com / password123');
    } catch (error) {
